...
+ 손이 닿지 않는 원거리에서도 콘센트를 뽑지 않아도 콘센트의 전류를 제어하기 위한 멀티탭을 구현하는게 프로젝트의 목표입니다.
...
2. 처음에는 블루투스를 이용하여 프로젝트를 진행하는 것이 아닌 Zigbee를 활용하기로 했었는데 Zigbee에 대한 지식 부족으로 인해 블루투스로 선회하였습니다.
