...
<h2> 일단 프로젝트를 구현하는 과정에서 멀티탭 외부 피복을 먼저 벗기고 내피를 자르는데 혹시 실수를 하여 내피에 손상이 생기면 감전이나 누전의 위험성이 있어서 멀티탭을 새로 구매해야 하기 때문에 매우 조심하며 진행했습니다. 구글링을 통해 멀티탭 안의 세개의 내피 중에 어떤 선을 잘라야 하는지 검색하고 그에 따라 진행하였습니다.
   그리고 처음에는 블루투스를 이용하여 프로젝트를 진행하는 것이 아닌 Zigbee를 활용하기로 했었는데 Zigbee에 대한 지식 부족으로 인해 블루투스로 선회하였습니다.
   마지막으로, 원래는 멀티탭 2구 각각의 전원을 따로 제어하려고 하였으나 릴레이모듈이 2채널이 아닌 1채널이라 어쩔 수 없이 동시에 전원을 제어할 수 밖에 없었던 점이 아쉬웠습니다.</h2>
